...
class BookInventory:
    ...
    def replace_book(self, index, new_titles, new_authors):
        try:
            ...
            print(f"An error occurred while replacing the book: {e}")
                    ...
                    while True:
                        ...
                        if choice == '1':
                            ...
                            try:
                                ...
                                print(f"An error occurred while viewing the inventory: {e}")

                        elif choice == '5':
                            try:
                                inventory.sort_books_az()
                            except Exception as e:
                                print(f"An error occurred while sorting the books: {e}")
